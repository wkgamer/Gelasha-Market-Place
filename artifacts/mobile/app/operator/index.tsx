            ...
            <View style={styles.productRow}>
              ...
              <View style={styles.actionBtns}>
                <Pressable style={styles.editBtn} onPress={() => openEditModal(item)}>
                  <Feather name="edit-2" size={16} color={Colors.light.tint} />
                </Pressable>
        ...
        <ScrollView contentContainerStyle={[styles.listContent, { paddingBottom: bottomPad + 100 }]}>
          ...
          {categories.filter((c) => c !== "All").map((cat) => (
            <View key={cat} style={styles.catRow}>
              <Ionicons name="folder-outline" size={18} color={Colors.light.tint} />
      ...
      <Modal visible={modalVisible} animationType="slide" presentationStyle="pageSheet">
        <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : undefined}>
          ...
          <ScrollView style={styles.modalBody} keyboardShouldPersistTaps="handled">
            ...
            <FormField label="Image URL *" value={form.imageUrl} onChange={(v) => setForm((f) => ({ ...f, imageUrl: v }))} placeholder="https://..." autoCapitalize="none" />
            ...
            <Text style={styles.formHint}>Add variants like sizes, colors, HP ratings etc. Each variant has its own price and optional image.</Text>
                  ...
                  <View key={v.id} style={styles.variantRow}>
                    {v.image ? (
                      ...
                      <View style={[styles.variantThumb, styles.variantThumbPlaceholder]}>
                        <Ionicons name="image-outline" size={16} color={Colors.light.textMuted} />
                      </View>
                    )}
            ...
            <View style={styles.addVariantSection}>
              ...
              <FormField label="Variant Name *" value={newVariant.name} onChange={(v) => setNewVariant((n) => ({ ...n, name: v }))} placeholder="e.g. 5HP, Red, Large" />
              <FormField label="Variant Price ₹ *" value={newVariant.price} onChange={(v) => setNewVariant((n) => ({ ...n, price: v }))} placeholder="e.g. 48000" keyboardType="decimal-pad" />
              <FormField label="Variant Image URL (Optional)" value={newVariant.image} onChange={(v) => setNewVariant((n) => ({ ...n, image: v }))} placeholder="https://... (changes image when selected)" autoCapitalize="none" />
              <Pressable
...
const styles = StyleSheet.create({
  ...
  headerCenter: { flex: 1 },
  headerTitle: {
    fontSize: 20, fontFamily: "Inter_700Bold", color: Colors.light.text,
  },
  headerSub: {
  ...
  tabText: {
    fontSize: 13, fontFamily: "Inter_600SemiBold", color: Colors.light.textSecondary,
  },
  ...
  productThumb: {
    width: 70, height: 70, borderRadius: 10, backgroundColor: Colors.light.backgroundSecondary,
  },
  ...
  variantBadge: {
    backgroundColor: Colors.light.tintUltraLight, borderRadius: 6, paddingHorizontal: 6, paddingVertical: 2,
  },
  ...
  variantThumb: { width: 40, height: 40, borderRadius: 8, backgroundColor: Colors.light.border },
  ...
  addVariantTitle: {
    fontSize: 14, fontFamily: "Inter_700Bold", color: Colors.light.tintDark, marginBottom: 8,
  },
  addVariantBtn: {
